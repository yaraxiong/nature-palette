...
export default function Hero({ onCaptureToday }: HeroProps) {
  return (
    <section className="flex flex-col items-center justify-center pt-32 pb-16 px-6 text-center">
      ...
      >
        ...
        <button
          onClick={onCaptureToday}
          className="group relative flex items-center justify-center gap-3 px-8 py-4 rounded-full glass glass-hover shadow-sm overflow-hidden"
          type="button"
        >
          ...
          <Camera
            className="w-4 h-4 text-[#4A5D4E] opacity-70"
            strokeWidth={1.5}
          />
