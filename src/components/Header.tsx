    ...
    <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-8 pointer-events-none">
      ...
      <div className="flex items-center gap-6 pointer-events-auto">
        {!user ? (
          ...
          >
            <User
              className="w-3.5 h-3.5 text-[#4A5D4E] opacity-60 group-hover:opacity-100 transition-opacity"
              strokeWidth={1.5}
            />
              ...
              <>
                ...
                <div className="absolute right-0 mt-3 z-[130] glass rounded-2xl shadow-xl border border-rain-border min-w-[180px] overflow-hidden">
                  <div className="px-4 py-3">
                    ...
                    <p className="mt-1 text-[12px] tracking-wide text-stone-700">
                      {user.displayName}
                    </p>
                  </div>
        ...
        <div className="hidden sm:block">
          <CloudRain
            className="w-5 h-5 text-[#4A5D4E] opacity-40"
            strokeWidth={1.5}
          />
        </div>
      </div>
